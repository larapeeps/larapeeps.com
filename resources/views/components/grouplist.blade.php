...
<div>
    ...
    <a class="block px-6 group hover:bg-gray-50 md:px-12" href="{{ route('group', ['group' => $group]) }}">
        <div class="py-6 border-b group-last:border-b-0 md:py-10">
            <div class="flex items-center">
                ...
                <div class="mb-1.5 flex-shrink-0 md:mb-1">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 text-gray-400">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
                    </svg>
                </div>
            </div>
            <p class="mt-1 pr-8 text-gray-700 md:hidden">{{ $group->description }}</p>
        </div>
    </a>
@endforeach
</div>
